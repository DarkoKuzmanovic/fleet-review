...
describe('ProviderRegistry.isSafeGatewayUrl', () => {
  ...
  it('blocks IPv4-compatible IPv6 (loopback)', () => expect(isSafe('https://[::127.0.0.1]/api')).toBe(false));
  it('blocks IPv4-compatible IPv6 (RFC 1918)', () => expect(isSafe('https://[::192.168.1.1]/api')).toBe(false));
  it('blocks IPv4-compatible IPv6 (normalized hex)', () => expect(isSafe('https://[::c0a8:101]/api')).toBe(false));
